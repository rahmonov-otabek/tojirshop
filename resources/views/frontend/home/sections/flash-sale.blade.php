                    ...
                    <div class="row">
                                ...
                                <div class="row modal_slider">
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ $product->thumb_image }}" alt="product" class="img-fluid w-100">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ $productImage->image }}" alt="{{ $productImage->name}}" class="img-fluid w-100">
                                        </div>
                                    </div> 
                                    @endforeach
                        ...
                        <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                            <div class="wsus__pro_details_text">
                                ...
                                @else
                                    <h4>{{ $settings->currency_icon }}{{ $product->offer_price }}</h4> 
                                @endif 
                                <p class="review">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
